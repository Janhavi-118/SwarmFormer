...
#include "swarm_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: error_flags
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.error_flags[index].size() + 1);
    }
  }
  // Member: heartbeat_count
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swarm_msgs::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const swarm_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<swarm_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &swarm_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}

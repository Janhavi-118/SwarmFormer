...
bool swarm_msgs__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("swarm_msgs.msg._robot_state.RobotState", full_classname_dest, 38) == 0);
  }
  swarm_msgs__msg__RobotState * ros_message = _ros_message;
  {  // robot_id
  ...
  {  // neighbors
    PyObject * field = PyObject_GetAttrString(_pymsg, "neighbors");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'neighbors'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->neighbors.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // local_obstacle_count
    PyObject * field = PyObject_GetAttrString(_pymsg, "local_obstacle_count");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->local_obstacle_count = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // battery_level
  ...
  {  // error_flags
    ...
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'error_flags'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->error_flags.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // heartbeat_count
    PyObject * field = PyObject_GetAttrString(_pymsg, "heartbeat_count");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->heartbeat_count = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * swarm_msgs__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("swarm_msgs.msg._robot_state");
  ...
  {  // neighbors
    ...
    rosidl_runtime_c__String * src = ros_message->neighbors.data;
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "neighbors", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // local_obstacle_count
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->local_obstacle_count);
    {
      int rc = PyObject_SetAttrString(_pymessage, "local_obstacle_count", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // error_flags
    ...
    rosidl_runtime_c__String * src = ros_message->error_flags.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // heartbeat_count
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->heartbeat_count);
    {
      int rc = PyObject_SetAttrString(_pymessage, "heartbeat_count", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
